...
def agent_alphabeta1_1(grid):
    return random.sample(alphabeta(grid,1,True,-float("inf"),float("inf"))[1],1)[0]
def agent_alphabeta1_2(grid):
    return random.sample(alphabeta(grid,2,True,-float("inf"),float("inf"))[1],1)[0]
def agent_alphabeta1_3(grid):
    return random.sample(alphabeta(grid,3,True,-float("inf"),float("inf"))[1],1)[0]
def agent_alphabeta1_4(grid):
    return random.sample(alphabeta(grid,4,True,-float("inf"),float("inf"))[1],1)[0]
def agent_alphabeta2_1(grid):
    return random.sample(alphabeta(grid,1,False,-float("inf"),float("inf"))[1],1)[0]
def agent_alphabeta2_2(grid):
    return random.sample(alphabeta(grid,2,False,-float("inf"),float("inf"))[1],1)[0]
def agent_alphabeta2_3(grid):
    return random.sample(alphabeta(grid,3,False,-float("inf"),float("inf"))[1],1)[0]
def agent_alphabeta2_4(grid):
